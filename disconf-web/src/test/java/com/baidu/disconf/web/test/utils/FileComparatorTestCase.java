...
public class FileComparatorTestCase {
    ...
    public void shouldGetChangesBetweenFiles() {
        ...
        try {
            final List<Chunk<String>> changesFromOriginal = comparator.getChangesFromOriginal();
            for (Chunk<String> chunk : changesFromOriginal) {
                System.out.println(chunk.toString());
            }
            assertEquals(3, changesFromOriginal.size());

            final Chunk<String> firstChange = changesFromOriginal.get(0);
            ...
            final Chunk<String> secondChange = changesFromOriginal.get(1);
            ...
            final Chunk<String> thirdChange = changesFromOriginal.get(2);
    ...
    public void shouldGetInsertsBetweenFiles() {
        ...
        try {
            final List<Chunk<String>> insertsFromOriginal = comparator.getInsertsFromOriginal();
            assertEquals(1, insertsFromOriginal.size());

            final Chunk<String> firstInsert = insertsFromOriginal.get(0);
    ...
    public void shouldGetDeletesBetweenFiles() {
        ...
        try {
            final List<Chunk<String>> deletesFromOriginal = comparator.getDeletesFromOriginal();
            assertEquals(1, deletesFromOriginal.size());

            final Chunk<String> firstDelete = deletesFromOriginal.get(0);
